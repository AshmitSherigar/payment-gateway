    ...
    <div className="min-h-screen bg-[#f4f1ea] px-6 py-8">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Link to="/dashboard">
          ...
          <div className="bg-[#0f172a] text-white  p-10 flex flex-col justify-between hover:scale-[1.02] transition-all duration-300 shadow-xl cursor-pointer">
        ...
        <Link to="/upi">
          ...
          <div className="bg-white rounded-[28px] p-10  flex flex-col justify-between hover: transition-all duration-300 shadow-xl border border-gray-200 cursor-pointer">
